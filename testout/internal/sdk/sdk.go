...
import (
	...
	"github.com/speakeasy/terraform-provider-terraform/internal/sdk/retry"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.503.2",
			UserAgent:         "speakeasy-sdk/terraform 0.0.1 2.503.2 1.0.0 github.com/speakeasy/terraform-provider-terraform/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
